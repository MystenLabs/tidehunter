...
const MAX_SERIALIZABLE_U16: u16 = 0x7FFF;
...
pub fn serialize_u16_varint<B: BufMut>(value: u16, buf: &mut B) {
    if value > MAX_SERIALIZABLE_U16 {
        panic!("Value {} exceeds maximum encodable value {}", value, MAX_SERIALIZABLE_U16);
    }
...
mod tests {
    ...
    fn test_u16_var_int_serialization() {
        ...
        let values = [0u16, MAX_SINGLE_BYTE_EXCLUDED -1, MAX_SINGLE_BYTE_EXCLUDED + 1, MAX_SINGLE_BYTE_EXCLUDED, 300, 255, 32767];
